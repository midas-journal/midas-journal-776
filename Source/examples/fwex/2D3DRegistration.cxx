...
{
  std::cout << "**********************************" << std::endl;
  std::cout << "***     2D/3D-REGISTRATION     ***" << std::endl;
  std::cout << "**********************************" << std::endl;

  std::cout << std::endl;
  std::cout << "Authors: Philipp Steininger, Markus Neuner" << std::endl;
  std::cout << "NOTE: This application makes use of open source libraries: " <<
    std::endl;
  std::cout << "  (*) The Insight Registration and Segmentation Toolkit " <<
    "(ITK) " << std::endl << "      [www.itk.org]" << std::endl;
  std::cout << std::endl;
  std::cout << std::endl;
  std::cout << "Application usage: 2D3DRegistration <config-file> " <<
 ...
 */
MultiResolutionImage2D3DRegistrationMethodCustom<>::InternalImageType::Pointer
 ...
 * with a 2D image outgoing from a manually configured intial position. <br>
 * The application is configured and parametrized by a configuration file (
 * have a look at the examplary file "RegistrationExample.cfg" in the source
 * folder).
...
int main(int argc, char *argv[])
{
  ...
  typedef MultiResolutionImage2D3DRegistrationMethodCustom<> RegistrationType;
  ...
  typedef MultiResolutionImage2D3DRegistrationMethodCustom<>::InternalImageType
    ImageType;
  ...
  if (metrictype == "MMI") // Mattes mutual information
    metric = static_cast<RegistrationType::BaseMetricType *>(
  ...
  if (success)
  {
    ...
    typedef MultiResolutionRegistrationCommandCustom<RegistrationType>
      RegObserverType;
